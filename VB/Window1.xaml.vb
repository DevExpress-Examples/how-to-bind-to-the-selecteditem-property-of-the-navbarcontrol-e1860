...
Namespace MVVM_SelectedItem
	...
	Partial Public Class Window1
		...
		Public Sub New()
			...
			DataBindingHelper.BuildContent(navBar, viewModel.Products, "Category", Nothing, Nothing)
	...
	Public Class ViewModel
		...
		Public Shared ReadOnly SelectedItemProperty As DependencyProperty = _
			DependencyProperty.Register("SelectedItem", GetType(Object), GetType(ViewModel), _
